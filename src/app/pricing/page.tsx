...
export const metadata: Metadata = {
  title: "Pricing — Tgat Premium",
  description: "Unlock unlimited Tgat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=tgat&cadence=annual`;
